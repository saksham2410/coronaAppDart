...
//       title: 'Covid19 Stats',
//       theme: ThemeData(
//         primaryColor: Colors.purple, backgroundColor: Color(0xffd4af37)
//       ),
//       darkTheme: ThemeData(
...
class _HomePageIndexState extends State<HomePageIndex> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text("Covid Visualiser - " + country),
      ),
          ...
          children: <Widget>[
            ...
            Row(
              ...
              children: <Widget>[
                ...
                Counter(
                  textStyle: TextStyle(color: Theme.of(context).primaryColor, fontSize: 18),
                  animation: new StepTween(
                    begin: 0, //prevTotalCases,
          ...
          child: Align(
            ...
            child: Container(
              ...
              child: FlatButton(
                ...
                child: Wrap(
                  children: <Widget>[
                    Icon(Icons.autorenew, color: Theme.of(context).primaryColor, size: 12),
                    Text(
